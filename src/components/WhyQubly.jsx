const WhyQubly = () => {
    return ( 
        <div className="w-full max-w-[1400px] mx-auto my-14 px-4">
            <div className="w-full flex justify-center">
                <div className="flex items-center rounded-full bg-secondary-100 w-fit text-secondary-200 font-medium text-[13px] md:text-sm py-2 px-3">
            ...
            <div className="w-full md:w-6/12 m-auto text-center mt-6">
                <h2 className="font-bold text-2xl md:text-[36px] text-primary-200 leading-tight mb-4">
